...
In development (`bun dev`) this post should appear in the blog listing and at its URL.

In production it should return a 404.

![Test image](/images/draft-test-post/test_image.png)
